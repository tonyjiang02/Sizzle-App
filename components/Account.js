        ...
        <View style={{backgroundColor: '#f2f2f2'}}>
            ...
            <View style={{paddingHorizontal: 15, paddingTop: 30}}>
                <TouchableOpacity style={{padding: 10}}>
                    <View style={{flexDirection: 'row', paddingHorizontal: 20, paddingVertical: 10, backgroundColor: 'white',
                ...
                <TouchableOpacity style={{padding: 10}}>
                    <View style={{flexDirection: 'row', paddingHorizontal: 30, paddingVertical: 5, backgroundColor: '#FDDFDF',
                                shadowColor: "#000", shadowOffset: {width: 0, height: 1}, shadowOpacity: 0.22, shadowRadius: 2.22,
                                elevation: 3, alignItems: 'center'}}>
