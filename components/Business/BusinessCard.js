...
const BusinessCard = ({ business, navigation, db, openBusinessPage }) => {
    ...
    if (openStatus === true) {
        openDisplay = <Text style={{
            paddingHorizontal: 2, alignSelf: 'center', color: 'white', fontSize: 10,
            borderColor: 'green', borderWidth: 1, paddingBottom: 3, backgroundColor: 'green'
        }}>Open</Text>;
    }
    else {
        openDisplay = <Text style={{
            alignSelf: 'center', color: 'white', fontSize: 10,
